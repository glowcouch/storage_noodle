...
#[proc_macro_derive(Read, attributes(config_noodle_sql, config_noodle_raw_id))]
...
#[proc_macro_derive(Update, attributes(config_noodle_sql, config_noodle_raw_id))]
...
#[proc_macro_derive(Delete, attributes(config_noodle_sql, config_noodle_raw_id))]
